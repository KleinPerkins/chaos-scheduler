...
- **Anchor:** security issue #292 (rotate the exposed scheduler API credential + make the tracked MCP config secret-free) is **OPEN**; the managed-key → Keychain migration is its foundational fix and this plan's base.
